...
select TeamID,TeamName,Goals,Points from
SportTeams join SportGoals
on TeamID = Team
...
-- the guy on the explains fully why the order by doesnt work however if you put top it should work perfectly
